...
* GAMs\_Data - Contains simulated fitted values from the GAMs models estimated in the Econometrics\_scripts. The predicted values represent the unexplained variation in mean expenditure per ha, stock value per ha, or revenue per ha given realisations of precicipitation over a four year period.
